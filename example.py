...
if __name__ == '__main__':
    ...
    # r_data.plot_data(r_data.data[0:300], figtype='pdf')  # Plot normalized data
    # -------------------------------------------------------
    ...
    # s.plot_peaks(s.data[0:300], sp0[0:300], figtype='pdf')
    # -------------------------------------------------------
    ...
    # c.plot_clusters(kmeans_clusters)   # Plot the clusters
